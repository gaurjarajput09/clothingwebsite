...
const products = [
    ...
    { name: 'Straight Fit Jeans', price: 2499, image: '/images/jeans1.jpg', category: 'Jeans', description: 'Straight fit' },
    { name: 'Skinny Fit Denim', price: 2499, image: '/images/jeans2.jpg', category: 'Jeans', description: 'Skinny fit' },
    { name: 'Ripped Jeans', price: 2499, image: '/images/jeans3.jpg', category: 'Jeans', description: 'Stylish ripped' },
    { name: 'Vintage Jeans', price: 2499, image: '/images/jeans4.jpg', category: 'Jeans', description: 'Vintage look' },
    { name: 'Mom Jeans', price: 2499, image: '/images/jeans5.jpg', category: 'Jeans', description: 'Classic mom jeans' },
    { name: 'Wide Leg Jeans', price: 2499, image: '/images/jeans6.jpg', category: 'Jeans', description: 'Wide leg fit' },
    { name: 'Cargo Jeans', price: 2499, image: '/images/jeans7.jpg', category: 'Jeans', description: 'Cargo style' },
    { name: 'Slim Fit Jeans', price: 2499, image: '/images/jeans8.jpg', category: 'Jeans', description: 'Slim fit' },
    { name: 'Casual Denim', price: 2499, image: '/images/jeans9.jpg', category: 'Jeans', description: 'Casual wear' },
    { name: 'Distressed Jeans', price: 2499, image: '/images/jeans10.jpg', category: 'Jeans', description: 'Distressed look' },
    ...
    // SHORT DRESSES
    { name: 'Party Short Dress', price: 3499, image: '/images/women_short_dress.png', category: 'Short Dresses', description: 'Perfect for parties' },
    { name: 'Velvet Short Dress', price: 3499, image: '/images/short1.webp', category: 'Short Dresses', description: 'Luxury velvet' },
    { name: 'Satin Mini Dress', price: 3499, image: '/images/short2.webp', category: 'Short Dresses', description: 'Smooth satin' },
    { name: 'Sequined Dress', price: 3499, image: '/images/short3.webp', category: 'Short Dresses', description: 'Shiny sequins' },
    { name: 'Bodycon Mini', price: 3499, image: '/images/short4.webp', category: 'Short Dresses', description: 'Bodycon fit' },
    { name: 'Floral Mini Dress', price: 3499, image: '/images/short6.webp', category: 'Short Dresses', description: 'Floral mini' },
    { name: 'Cocktail Dress', price: 3499, image: '/images/short5.webp', category: 'Short Dresses', description: 'Cocktail party' },
    { name: 'Fit & Flare Mini', price: 3499, image: '/images/short7.webp', category: 'Short Dresses', description: 'Fit and flare' },
    { name: 'Little Black Dress', price: 3499, image: '/images/short11.webp', category: 'Short Dresses', description: 'Timeless LBD' },
    { name: 'Elegant Mini', price: 3499, image: '/images/short8.webp', category: 'Short Dresses', description: 'Elegant design' },
    { name: 'Summer Mini Dress', price: 3499, image: '/images/short9.webp', category: 'Short Dresses', description: 'Summer mini' },
    { name: 'Wrap Mini Dress', price: 3499, image: '/images/short10.webp', category: 'Short Dresses', description: 'Wrap style' },
